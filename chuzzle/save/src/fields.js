...
const known = {
    ...
    SoundVolume: {panel: "player", label: "Sound volume", note: "0 to 1"},
    MusicVolume: {panel: "player", label: "Music volume", note: "0 to 1"},
    ...
    AwardedDailyDo: {panel: "dailydo", label: "Awarded on", note: "YYYYDDMM"},
    DDAlreadyPlayedVersion: {panel: "dailydo", label: "Played version"},
    DDGotXP: {panel: "dailydo", label: "Last xp day", note: "YYYYDDMM"},
    ...
    DDPrizes: {panel: "dailydo", label: "Prizes taken", note: "| separated"},
    DDPendingPrizes: {panel: "dailydo", label: "Prizes waiting"},
    DDPendingPrizesBeta1: {panel: "dailydo", label: "Prizes waiting (beta)"},
    FreeDo: {panel: "dailydo", label: "Free plays"},
    ContinueDailyDo: {panel: "dailydo", label: "Continue day", note: "YYYYDDMM"},
    ContinueDailyDoVersion: {panel: "dailydo", label: "Continue version"},
    GoldenOne: {panel: "dailydo", label: "Golden one day", note: "YYYYDDMM"},
    ...
    GotTrophyTime: {panel: "dailydo", label: "Trophy dates"},
    ...
    LastBossType: {panel: "runs", label: "Last boss types"},
